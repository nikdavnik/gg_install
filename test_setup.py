...
class KongSetup(object):
    ...
    def promptForProperties(self):
        ...
        # Env Variable is used
        self.kongaOPHost = "ce-dev6.gluu.org"
        ...
        # Env Variable is used
        self.kongaOxdWeb = "https://localhost:8443"
        # Env Variable is used  
        self.generateClient = self.makeBoolean("Y")
    ...
    try:
        if kongSetup.isPrompt:
            msg = "------------------------------------------------------------------------------------- \n" \
                  ...
                  + "------------------------------------------------------------------------------------- \n"
            print msg
            kongSetup.license = kongSetup.makeBoolean("Y")
            print ""
